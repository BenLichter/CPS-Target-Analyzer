        ...
        <div style={{background:C.surface,borderBottom:"1px solid "+C.border,padding:"14px 20px"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(380px,1fr))",gap:12}}>
            {[
              ...
              {label:"NinjaPear",icon:"🎯",desc:"Verified LinkedIn URLs · $0.01-0.10/lookup",sk:STORAGE.ninjapear,val:ninjapearKey,fn:v=>saveKey(STORAGE.ninjapear,v,setNinjapearKey),ph:"api-key  →  ninjabear.io (10 free credits)"},
